...
export const sorceries: SorceryEntry[] = [
...

  {
    ...
    abilities: [
      ...
      { slot: "Awakening", name: { en: "True Realm of Sumika", ru: "Истинное Царство Сумики" }, desc: { en: "A server-owned one-shot scene: lock every entity in 64 blocks, manifest True Realm and pierce valid targets in camera order. Damage ignores Stability. Lesser living entities die at the destructive phase; the cinematic target gamerule defaults to 10 close-ups without reducing hits.", ru: "Одноразовая server-owned сцена: блокирует все сущности в 64 блоках, проявляет Истинное Царство и пробивает допустимые цели в порядке камеры. Урон игнорирует Stability. Слабые существа погибают в разрушительной фазе; gamerule по умолчанию даёт 10 крупных планов, не уменьшая число ударов." } }
    ],
    asset: undefined
  },
